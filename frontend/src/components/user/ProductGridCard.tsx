export const ProductGridCard = () => {
    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-2">
            <div className="py-3 border-b-2 flex justify-center space-x-3 cursor-pointer hover:shadow-sm">
                <div className="h-auto w-[40px] rounded-lg">
                ...
                <div className="flex flex-col justify-center">
                    <div className="flex justify-center space-x-1">
                        ...
                        <div className="break-words whitespace-normal overflow-wrap-anywhere">
                            Notion like email builder and beautiful email template jandsa salkjnaol sdaolkdj oaslkjdoa skjcalk sjxvncx
                        </div>
                    </div>
