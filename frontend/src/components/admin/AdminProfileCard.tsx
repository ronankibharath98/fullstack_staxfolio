...
import { ProductGridCard } from "../user/ProductGridCard"
...
export const AdminProfileCard = () => {
    ...
    return (
        <>
            {user && role == "Admin" ? (
                <div className="px-20 pt-10 h-screen w-full grid grid-cols-1 lg:grid-cols-3 space-x-5">
                    ...
                    <div className="hidden lg:block mb-10 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        <div className="p-10 font-medium text-xl text-center text-gray-500">
                            Your leadership and efforts are driving the success of our platform. Keep up the great work!
                        </div>
                        <div className="mt-10 flex flex-col text-gray-700 space-y-10">
